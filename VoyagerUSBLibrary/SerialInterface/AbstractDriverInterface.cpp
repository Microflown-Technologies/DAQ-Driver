...
AbstractDriverInterface::AbstractDriverInterface(EventManager *eventmanager, InterThreadStorage* interthreadstorage): m_interThreadStorage(interthreadstorage), m_eventManager(eventmanager) ,m_handle(NULL), m_connectionState()
{
}
